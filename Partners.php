...
$partners = $db->query("SELECT * FROM `parthers`")->fetchAll();
   ...
   <div class="darkness">
    ...
    <main>
        ...
        <div class='partners'>
            ...
            <?php
            foreach($partners as $friend){
            ?>

            <div class="frends">
                <img src="<?php print($friend['img']);?>" alt="">
                <div>
                    <p class="accent"><?php print($friend['name']);?></p><br>
                    <p><?php print($friend['description']);?></p>
                </div>
            </div>
