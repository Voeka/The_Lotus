...
$actualnews = $db->query("SELECT * FROM `news` ORDER BY `date` DESC")->fetchAll();
// print_r($actualnews);
...
<body>
   ...
   <div class="darkness">
    ...
    <main>
        ...
        <?php foreach($actualnews as $new){ ?>
            <div class='green block'>
                <h3><?php print($new['name']); ?></h3>
                <img src="<?php print($new['img']); ?>" alt="">
                <p><?php print($new['text']); ?></p>
                <a href="<?php print($new["adress"]); ?>">Подробнее</a>
            </div>
            <br>
