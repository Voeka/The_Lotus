...
$actualnews = $db->query("SELECT * FROM `news` ORDER BY `date` DESC LIMIT 1")->fetch();
...
if(isset($_POST)){
    ...
    if(!empty($_POST['regin'])){
        ...
        (`id`, `login`, `password`, `role`, `email`, `fam`, `name`, `sname`, `tel`, `dabirh`, `img`, `kurse`, `lesson1`, `lesson2`, `lesson3`) VALUES 
...
<body>
    ...
    <header>
        ...
        <div class="buttons">
            ...
            <?php if($_SESSION['user']['role']=='admin'){ ?>
                <button class="green" id="admin" onclick="admin()"><p>Админ</p></button>
            <?php }?>
    ...
    <main>
        ...
        <iframe width="100%" height="650" src="https://www.youtube.com/embed/mLq5kPh58b8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <h2>Новости</h2>
        <div class="green block">
            <img src="<?php print($actualnews["3"]); ?>" alt="">
            <h3><?php print($actualnews["1"]); ?></h3>
            <p>
            <?php print($actualnews["2"]); ?>
            </p>
            <a href="<?php print($actualnews["4"]); ?>">Подробнее</a>
        </div>
